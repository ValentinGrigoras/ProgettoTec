...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    <ul class="cd-accordion-menu animated">
      ...
      <ul>
        <li><a href="html/pages/su_di_noi.php">Chi Siamo</a></li>
    ...
    <div id="main_nav">
      ...
      <div id="nav">
        <ul>
          ...
          <li class="dropdown">
            <a href="javascript:void(0)" class="dropbtn">Su di noi<i class="fas fa-sort-down"></i> </a>
              <div class="dropdown-content">
                  <a href="html/pages/su_di_noi.php">Chi siamo</a>
                  <a href="#">FAQ</a>
          ...
          <li><a href="html/pages/corsi.php">Corsi</a></li>
...
<div id="allenatori_section">
	<div id="allenatori_content">
		...
		<dl class="twoColumnsCard">
  			<dt>Dimitri Vegas</dt>
  			<dd class="twoColumnsCardInner">
...
<div id="corsi_section">
  <div id="content_corsi">
    ...
    <div class="twoColumnsCardDetails">

...
if (!isset($_SESSION["autorizzato"]) || $_SESSION["autorizzato"]==0){
    ...
    switch ($uri_case[2]){
        case "user_panel":
            ...
            $header = str_replace("*breadcrumbs*","Ti trovi in: Area Personale",$header);
...
if (!isset($_SESSION["autorizzato"]) || $_SESSION["autorizzato"]==0){
    ...
    $header = str_replace("*linklogin*","<li><a href='./logout' xml:lang='en' tabindex=\"$tabIndex\">Logout</a></li>",$header);
